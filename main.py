...
def get_arguments():
    ...
    """
    parser = argparse.ArgumentParser(description="Self Correction for Cloth Segmentation")
...
def main():
    ...
    train_dataset = ClothDataset(args.data_dir, 'train', crop_size=input_size, transform=transform)
